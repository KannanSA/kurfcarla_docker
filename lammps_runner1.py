...
if __name__ == '__main__':
    ...
    # --- THIS IS THE FIX ---
    # Use the serial version of the LAMMPS executable to avoid MPI errors
    parser.add_argument('--lammps', type=str, default='lmp_serial', help='LAMMPS command')
